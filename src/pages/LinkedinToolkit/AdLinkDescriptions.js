...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    e.preventDefault();
    const linkedinlinkdesc = {
      company: this.state.company,
      audience: this.state.audience,
      background: this.state.background,
    }
    axios.post("https://app2.ellipsis-ai.com/api/v1/linkedinlinkdesc/", linkedinlinkdesc,{auth:{
      ...
      <React.Fragment>
        ...
        <Row>
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"adlinkdescriptions.csv"}>Download</CSVLink>
