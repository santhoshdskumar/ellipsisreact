...
formSubmit(e) {
  ...
  axios.post("https://app2.ellipsis-ai.com/api/v1/sponsoredmail/", sponsoredmail,{auth:{
      ...
      <React.Fragment>
        ...
        <Row>
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"salesemails.csv"}>Download</CSVLink>
