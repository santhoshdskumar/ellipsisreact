              ...
              <Card.Body>
                ...
                <Form className="p-0">
                  ...
                  <Form.Group className="mb-4" controlId="solve">
                    ...
                    <Form.Control type="text" maxLength="20" name="solve"  value={this.state.solve}   onChange={(event)=>this.wordCountTwo(event)}/>
                  ...
                  <Form.Group className="mb-4" controlId="market">
                    ...
                    <Form.Control type="text" maxLength="20" name="market"  value={this.state.market}   onChange={(event)=>this.wordCountTwo(event)}/>
