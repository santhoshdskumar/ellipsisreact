...
class GoogleAds extends React.Component {
  ...
  handleSubmit = () => {
    ...
    axios.post("https://app2.ellipsis-ai.com/api/v1/dynamicads/", dynamicads,{auth:{
      ...
      <React.Fragment>
        ...
        <Row>
              ...
              <Card.Body>
                ...
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="product">
                    ...
                    <Form.Control type="text" maxLength="20" name="product" 
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"dynamicads.csv"}>Download</CSVLink>
