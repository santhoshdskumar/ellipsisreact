...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios
      .post(
        'https://app2.ellipsis-ai.com/api/v1/articlegeneration/',
        articlegeneration,
        {
          headers: {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <h1 class="headTitle">Article Generator</h1>
        <Row>
          <Col
            xs={12}
            lg={4}
          ...
          >
            <Card>
              ...
              <Card.Body>
                <p>Generate full-length, original articles. </p>
                <Form className="p-0" onSubmit={this.formSubmit}>
                  <Form.Group className="mb-4" controlId="description">
                    ...
                    <Form.Control
                      ...
                      rows={3}
                      maxLength="140"
                      placeholder="Paste the first few sentences of your article and let AI finish the article "
                      name="description"
