...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios
      .post(
        'https://app2.ellipsis-ai.com/api/v1/herotext/',
        herotext,
        {
          headers: {
                ...
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="background">
                    ...
                    <Form.Control
                      as="textarea"
                      rows={3}
                      placeholder="Gather important details from a PSD file without the need for Photoshop"
                      maxLength="140"
                      name="background"
          ...
          <Col xs={12} lg={8} sm={12} className="NotificationEdit">
            <Card>
              ...
              <div className="clearConsole">
                ...
                <CSVLink data={this.state.csvData} filename={'herotext.csv'}>
                  Download
                </CSVLink>
              </div>
            </Card>
