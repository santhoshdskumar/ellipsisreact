...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios
      .post(
        'https://app2.ellipsis-ai.com/api/v1/problemsoln/',
        problemsoln,
        {
          headers: {
                ...
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="audience">
                    ...
                    <Form.Control
                      ...
                      maxLength="20"
                      name="audience"
                      placeholder="Designers & Developers"
                  ...
                  <Form.Group className="mb-4" controlId="background">
                    ...
                    <Form.Control
                      ...
                      maxLength="140"
                      name="background"
                      placeholder="Working with Photoshop files is cumbursome and tedious"
