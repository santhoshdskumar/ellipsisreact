...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios.post("https://app2.ellipsis-ai.com/api/v1/featurebenefit/", featurebenefit,{auth:{
      ...
      <React.Fragment>
        ...
        <Row>
          <Col xs={12} lg={4} sm={12} md={12} className="mb-md-5 toolkitWebsite">
            <Card>
              <Card.Header>
                <h3>Feature - Benefits</h3>
              </Card.Header>
              <Card.Body>
                <p>Showcase how your product features translates into benefits for your customers</p>
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="audience">
                    ...
                    <Form.Control type="text" maxLength="20" name="audience"  value={form.audience}  
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"featurebenefits.csv"}>Download</CSVLink>
