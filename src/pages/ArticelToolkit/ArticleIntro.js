...
formSubmit(e) {
  ...
  axios.post("https://app2.ellipsis-ai.com/api/v1/articleintro/", articleintro,{auth:{
        ...
        <Row>
          <Col xs={12} lg={4} sm={12} md={12} className="mb-md-5 toolkitWebsite">
            <Card>
              ...
              <Card.Body>
                <p>Let AI write the first 200 words of your article</p>
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"articleintro.csv"}>Download</CSVLink>
