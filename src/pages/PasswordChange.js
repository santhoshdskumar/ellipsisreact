    ...
    <Form className="p-0"> 
          ...
          <Form.Group className="mb-4">
            ...
            <Form.Control
                ...
                onChange={this.handleChange3} placeholder="Old Password"
            />
            </Form.Group>
            <Form.Group className="mb-4">
            ...
            <Form.Control
                ...
                onChange={this.handleChange1} placeholder="New Password"
            />
            </Form.Group>
            <Form.Group className="mb-4">
            ...
            <Form.Control
                ...
                onChange={this.handleChange2} placeholder="Confirm Password"
            />
            </Form.Group>
