...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios.post("https://app2.ellipsis-ai.com/api/v1/event_followup_mail/", event_followup_mail,{auth:{
      ...
      <React.Fragment>
        ...
        <Row>
              ...
              <Card.Body>
                ...
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="offer">
                    ...
                    <Form.Control type="text" maxLength="20" name="offer"  value={form.offer}   
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"eventfollowupemails.csv"}>Download</CSVLink>
