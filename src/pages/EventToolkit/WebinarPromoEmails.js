...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios.post("https://app2.ellipsis-ai.com/api/v1/webinar_promo_mail/", webinar_promo_mail,{auth:{
      ...
      <React.Fragment>
        ...
        <Row>
          <Col xs={12} lg={4} sm={12} md={12} className="mb-md-5 toolkitWebsite">
            <Card>
              <Card.Header>
                <h3>Webinar Promo Emails</h3>
              </Card.Header>
              <Card.Body>
                <p>Drive Registrations for online format events</p>
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"webinarpromoemails.csv"}>Download</CSVLink>
