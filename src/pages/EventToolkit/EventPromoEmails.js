...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios.post("https://app2.ellipsis-ai.com/api/v1/event_promo_mail/", event_promo_mail,{auth:{
        ...
        <Row>
          <Col xs={12} lg={4} sm={12} md={12} className="mb-md-5 toolkitWebsite">
            <Card>
              ...
              <Card.Body>
                <p>High impact event launch promotions</p>
          ...
          <Card>
              ...
              <CSVLink data={this.state.csvData} filename={"eventpromoemails.csv"}>Download</CSVLink>
