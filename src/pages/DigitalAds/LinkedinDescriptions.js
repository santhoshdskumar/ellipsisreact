...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios.post("https://app2.ellipsis-ai.com/api/v1/metatags/", linkdesc,{auth:{
        ...
        <Row>
          <Col xs={12} lg={4} sm={12} md={12} className="mb-md-5 toolkitWebsite">
            <Card>
              ...
              <Card.Body>
                <p>Metadata for all your landing pages</p>
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="product">
                    ...
                    <Form.Control type="text" maxLength="20" name="product"  value={this.state.value}   
