...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios
      .post(
        'https://app2.ellipsis-ai.com/api/v1/freeuser_engagement/',
        freeuserengagement,
        {
          headers: {
                ...
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="background">
                    ...
                    <Form.Control
                      ...
                      maxLength="140"
                      name="background"
                      placeholder="Delivers emails promotions to inbox and not spam folder and provides detailed analytics on performance"
                      value={this.state.value}
                      onChange={(e) => {
                        this.wordCountSix(e);
                        this.handleChange(e);
            ...
            <Card>
              ...
              <div className="clearConsole">
                ...
                <CSVLink
                  ...
                  filename={'freeuserengagement.csv'}
                >
                  Download
                </CSVLink>
              </div>
