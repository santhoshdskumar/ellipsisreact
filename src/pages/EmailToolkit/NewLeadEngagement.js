...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios
      .post(
        'https://app2.ellipsis-ai.com/api/v1/newlead_engagement/',
        newleadengagement,
        {
          headers: {
                ...
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="event">
                    ...
                    <Form.Control
                      ...
                      placeholder="user signed up free trial/ newsletter/ downloaded ebook/: Downloaded eBook"
                      maxLength="20"
                      onChange={(e) => {
                  ...
                  <Form.Group className="mb-4" controlId="background">
                    ...
                    <Form.Control
                      as="textarea"
                      rows={3}
                      placeholder="App to help you get more productive and accomplish great goals. Weekly blog with actionable insights"
                      maxLength="140"
                      name="background"
            ...
            <Card>
              ...
              <div className="clearConsole">
                ...
                <CSVLink
                  ...
                  filename={'newleadengagement.csv'}
                >
                  Download
                </CSVLink>
              </div>
