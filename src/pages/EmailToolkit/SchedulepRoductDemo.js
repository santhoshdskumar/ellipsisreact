...
class GoogleAds extends React.Component {
  ...
  formSubmit(e) {
    ...
    axios
      .post(
        'https://app2.ellipsis-ai.com/api/v1/schedule_product_demo/',
        ...
        <Row>
          ...
          >
            <Card>
              ...
              <Card.Body>
                <p>Get that time commitment from prospects for a demo</p>
                <Form className="p-0" onSubmit={this.formSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="background">
                    ...
                    <Form.Control
                      ...
                      rows={3}
                      maxLength="140"
                      placeholder="Software for personalising marketing campaigns based on customer's online behaviour and improving conversions"
                      name="background"
            ...
            <Card>
              ...
              <div className="clearConsole">
                ...
                <CSVLink
                  ...
                  filename={'scheduleproductdemo.csv'}
                >
                  Download
                </CSVLink>
              </div>
